...
apt-get -y install raspi-config rpi-update debconf htop bc initscripts net-tools libssl-dev raspberrypi-kernel-headers bison screen iperf libnl-route-3-200 libnl-genl-3-200 libnl-3-200  libnl-genl-3-dev libncurses5-dev lshw bridge-utils libnl-dev libssl-dev file build-essential	curl usbutils iptables nano wireless-tools iw git unzip dkms bc python ethtool
